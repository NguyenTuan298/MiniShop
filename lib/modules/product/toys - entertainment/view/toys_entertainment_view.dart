...
class ToysEntertainmentView extends GetView<ToysEntertainmentView> {
  const ToysEntertainmentView({super.key});

  @override
  Widget build(BuildContext context) {
    final ToysEntertainmentController controller = Get.find<ToysEntertainmentController>();
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        final product = Product(
                          ...
                          name: name,
                          category: 'toys_entertainment',                          // đúng category màn này
                          description: '',
                          price: price,
                          imageUrl: imageUrl,
                          stock: 999,
