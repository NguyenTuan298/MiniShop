// lib/screens/electronics_view.dart
...
class ElectronicsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ElectronicsController controller = Get.find<ElectronicsController>();
    final CartController cartController = Get.find<CartController>(); // Giả định có CartController
